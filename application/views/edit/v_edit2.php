<div class="container">
  <?php foreach ($isi->result() as $row): ?>
    <form action="<?php echo base_url(). 'Edit/save_edit_img1'; ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="konten" rows="3"><?php echo ucwords($row->konten);?></textarea>
      </div>
      <div class="row">
        <div class="col-md-2">
          <label class="newbtn"> 
